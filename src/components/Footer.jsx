...
export const Footer = () => {
  ...
  return (
    <footer className="bg-darkGreen flex flex-col justify-evenly">
      <div className="flex flex-row text-white justify-between py-10 px-14 font-serif">
      ...
      <p className="text-white mb-5 w-full text-center font-serif">
        Copyright {year} Westney Heights Medical Centre | All Rights Reserved |
        Designed by{" "}
        <a
